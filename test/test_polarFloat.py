...
from polarALL import random_sequence_tensor, process_sequence_polar, polar_to_complex_tensor
import torch
import numpy as np
...
def compare_precision():
    ...
    # int8 版本
    print("\n运行 polarALL.py (int8)...")
    from polarALL import process_sequence_polar, polar_to_complex_tensor  # Already imported at module level
