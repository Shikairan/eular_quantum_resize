...
vector_weak_wm = PolarVector(amplitude_dtype=torch.int16, phase_dtype=torch.int16, wm_a=None)
...
def compare_three_implementations(n_qubits=4, a=30, b=0, c=0, use_weak_wm=False):
    """
    ...
    Args:
        ...
        use_weak_wm: 是否对WM系统使用弱变换(wm_a=None)以提高与DeepQ兼容性、降低误差
    """
